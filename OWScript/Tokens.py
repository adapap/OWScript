...
CONST = ['ABORT WHEN FALSE', 'ALL HEROES', 'ALL', 'ANA', 'ASHE', 'ATTACKER', 'BACKWARD', 'BAD AURA SOUND', 'BAD AURA', 'BAPTISTE', 'BASTION', 'BEACON SOUND', 'BLUE', 'BRIGITTE', 'CLIP AGAINST SURFACES', 'CLOUD', 'CONTROL MODE SCORING TEAM', 'CURRENT ARRAY ELEMENT', 'D.VA', 'DECAL SOUND', 'DESTINATION AND DURATION', 'DESTINATION AND RATE', 'DO NOT CLIP', 'DOOMFIST', 'DOWN', 'EMPTY ARRAY', 'ENERGY SOUND', 'EVENT PLAYER', 'EVENT WAS CRITICAL HIT', 'FALSE', 'FORWARD', 'GENJI', 'GOOD AURA SOUND', 'GOOD AURA', 'GREEN', 'HANZO', 'IGNORE CONDITION', 'IS ASSEMBLING HEROES', 'IS BETWEEN ROUNDS', 'IS CONTROL MODE POINT LOCKED', 'IS CTF MODE IN SUDDEN DEATH', 'IS GAME IN PROGRESS', 'IS IN SETUP', 'IS MATCH COMPLETE', 'IS WAITING FOR PLAYERS', 'JUNKRAT', 'LAST CREATED ENTITY', 'LEFT', 'LIGHT SHAFT', 'LÚCIO', 'MCCREE', 'MEI', 'MERCY', 'MOIRA', 'NONE', 'NULL', 'OFF', 'ONGOING - EACH PLAYER', 'ONGOING - GLOBAL', 'ORB', 'ORISA', 'PAYLOAD POSITION', 'PHARAH', 'PICK-UP SOUND', 'PLAYER DEALT DAMAGE', 'PLAYER DEALT FINAL BLOW', 'PLAYER DIED', 'PLAYER EARNED ELIMINATION', 'PLAYER TOOK DAMAGE', 'POSITION AND RADIUS', 'PURPLE', 'REAPER', 'RECEIVERS AND DAMAGERS', 'RECEIVERS DAMAGERS AND DAMAGE PERCENT', 'RED', 'REINHARDT', 'RESTART WHEN TRUE', 'RIGHT', 'RING', 'ROADHOG', 'SMOKE SOUND', 'SOLDIER: 76', 'SOMBRA', 'SPARKLES SOUND', 'SPARKLES', 'SPHERE', 'STRING', 'SURFACES AND ALL BARRIERS', 'SURFACES AND ENEMY BARRIERS', 'SURFACES', 'SYMMETRA', 'TEAM 1', 'TEAM 2', 'TOP', 'TORBJÖRN', 'TRACER', 'TRUE', 'UP', 'VICTIM', 'VISIBLE TO AND STRING', 'VISIBLE TO POSITION AND RADIUS', 'VISIBLE TO POSITION AND STRING', 'VISIBLE TO', 'WHITE', 'WIDOWMAKER', 'WINSTON', 'WRECKING BALL', 'YELLOW', 'ZARYA', 'ZENYATTA']
