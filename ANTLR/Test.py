...
class Test ( Parser ):
    ...
    class ScriptContext(ParserRuleContext):
        ...
        def EOF(self):
            return self.getToken(Test.EOF, 0)

        def NEWLINE(self, i:int=None):
            if i is None:
                return self.getTokens(Test.NEWLINE)
            else:
                return self.getToken(Test.NEWLINE, i)

        def stmt(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Test.StmtContext)
            else:
                return self.getTypedRuleContext(Test.StmtContext,i)


        def getRuleIndex(self):
            return Test.RULE_script
    ...
    def script(self):
        ...
        localctx = Test.ScriptContext(self, self._ctx, self.state)
        ...
        try:
            ...
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << Test.T__0) | (1 << Test.T__1) | (1 << Test.NEWLINE))) != 0):
                self.state = 24
                self._errHandler.sync(self)
                token = self._input.LA(1)
                if token in [Test.NEWLINE]:
                    self.state = 22
                    self.match(Test.NEWLINE)
                    pass
                elif token in [Test.T__0, Test.T__1]:
                    self.state = 23
                    self.stmt()
                    pass
                else:
    ...
    class StmtContext(ParserRuleContext):
        ...
        def funcdef(self):
            return self.getTypedRuleContext(Test.FuncdefContext,0)


        def ruleset(self):
            return self.getTypedRuleContext(Test.RulesetContext,0)


        def getRuleIndex(self):
            return Test.RULE_stmt
    ...
    def stmt(self):
        ...
        localctx = Test.StmtContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [Test.T__0]:
                self.state = 31
                self.funcdef()
                pass
            elif token in [Test.T__1]:
                self.state = 32
                self.ruleset()
                pass
            else:
    ...
    class FuncdefContext(ParserRuleContext):
        ...
        def NAME(self):
            return self.getToken(Test.NAME, 0)

        def getRuleIndex(self):
            return Test.RULE_funcdef
    ...
    def funcdef(self):
        ...
        localctx = Test.FuncdefContext(self, self._ctx, self.state)
        self.enterRule(localctx, 4, self.RULE_funcdef)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 35
            self.match(Test.T__0)
            self.state = 36
            self.match(Test.NAME)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    class RulesetContext(ParserRuleContext):
        ...
        def ruledef(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Test.RuledefContext)
            else:
                return self.getTypedRuleContext(Test.RuledefContext,i)


        def getRuleIndex(self):
            return Test.RULE_ruleset
    ...
    def ruleset(self):
        ...
        localctx = Test.RulesetContext(self, self._ctx, self.state)
    ...
    class RuledefContext(ParserRuleContext):
        ...
        def rulename(self):
            return self.getTypedRuleContext(Test.RulenameContext,0)


        def rulebody(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Test.RulebodyContext)
            else:
                return self.getTypedRuleContext(Test.RulebodyContext,i)


        def getRuleIndex(self):
            return Test.RULE_ruledef
    ...
    def ruledef(self):
        ...
        localctx = Test.RuledefContext(self, self._ctx, self.state)
        self.enterRule(localctx, 8, self.RULE_ruledef)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 43
            self.match(Test.T__1)
            self.state = 44
            self.rulename()
            self.state = 48
            self._errHandler.sync(self)
    ...
    class RulenameContext(ParserRuleContext):
        ...
        def STRING(self):
            return self.getToken(Test.STRING, 0)

        def getRuleIndex(self):
            return Test.RULE_rulename
    ...
    def rulename(self):
        ...
        localctx = Test.RulenameContext(self, self._ctx, self.state)
        self.enterRule(localctx, 10, self.RULE_rulename)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 51
            self.match(Test.STRING)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    class RulebodyContext(ParserRuleContext):
        ...
        def NEWLINE(self):
            return self.getToken(Test.NEWLINE, 0)

        def INDENT(self):
            return self.getToken(Test.INDENT, 0)

        def DEDENT(self):
            return self.getToken(Test.DEDENT, 0)

        def block(self):
            return self.getTypedRuleContext(Test.BlockContext,0)


        def getRuleIndex(self):
            return Test.RULE_rulebody
    ...
    def rulebody(self):
        ...
        localctx = Test.RulebodyContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(Test.NEWLINE)
            self.state = 54
            self.match(Test.INDENT)
            self.state = 55
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << Test.T__2) | (1 << Test.T__3) | (1 << Test.T__4))) != 0)):
    ...
    class BlockContext(ParserRuleContext):
        ...
        def line(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Test.LineContext)
            else:
                return self.getTypedRuleContext(Test.LineContext,i)


        def getRuleIndex(self):
            return Test.RULE_block
    ...
    def block(self):
        ...
        localctx = Test.BlockContext(self, self._ctx, self.state)
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not (_la==Test.INTEGER or _la==Test.NEWLINE):
                    break
    ...
    class LineContext(ParserRuleContext):
        ...
        def number(self):
            return self.getTypedRuleContext(Test.NumberContext,0)
    ...
    def line(self):
        ...
        localctx = Test.LineContext(self, self._ctx, self.state)
        self.enterRule(localctx, 16, self.RULE_line)
        try:
            self.state = 72
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [Test.INTEGER]:
                self.enterOuterAlt(localctx, 1)
                self.state = 70
                self.number()
                pass
            elif token in [Test.NEWLINE]:
    ...
    def name(self):
        ...
        localctx = Test.NameContext(self, self._ctx, self.state)
    ...
    class NumberContext(ParserRuleContext):
        ...
        def INTEGER(self):
            return self.getToken(Test.INTEGER, 0)

        def getRuleIndex(self):
            return Test.RULE_number
    ...
    def number(self):
        ...
        localctx = Test.NumberContext(self, self._ctx, self.state)
        self.enterRule(localctx, 20, self.RULE_number)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 76
            self.match(Test.INTEGER)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
