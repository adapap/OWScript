...
CONST = ['ABILITY 1', 'ABILITY 2', 'ABORT WHEN FALSE', 'ALL BARRIERS BLOCK LOS', 'ALL HEROES', 'ALL', 'ANA', 'ARROW: DOWN', 'ARROW: LEFT', 'ARROW: RIGHT', 'ARROW: UP', 'ASHE', 'ASLEEP', 'ASTERISK', 'ATTACKER', 'BACKWARD', 'BAD AURA SOUND', 'BAD AURA', 'BAD EXPLOSION', 'BAD PICKUP EFFECT', 'BAPTISTE', 'BARRIERS DO NOT BLOCK LOS', 'BASTION', 'BEACON SOUND', 'BLUE', 'BOLT', 'BRIGITTE', 'BUFF EXPLOSION SOUND', 'BUFF IMPACT SOUND', 'BURNING', 'CANCEL CONTRARY MOTION', 'CHECKMARK', 'CIRCLE', 'CLIP AGAINST SURFACES', 'CLOUD', 'CLUB', 'CONTROL MODE SCORING TEAM', 'CROUCH', 'CURRENT ARRAY ELEMENT', 'D.VA', 'DEBUFF IMPACT SOUND', 'DECAL SOUND', 'DESTINATION AND DURATION', 'DESTINATION AND RATE', 'DIAMOND', 'DIZZY', 'DO NOT CLIP', 'DOOMFIST', 'DOWN', 'EMPTY ARRAY', 'ENEMY BARRIERS BLOCK LOS', 'ENERGY SOUND', 'EVENT PLAYER', 'EVENT WAS CRITICAL HIT', 'EXCLAMATION MARK', 'EXPLOSION SOUND', 'EYE', 'FALSE', 'FIRE', 'FLAG', 'FORWARD', 'FROZEN', 'GENJI', 'GOOD AURA SOUND', 'GOOD AURA', 'GOOD EXPLOSION', 'GOOD PICKUP EFFECT', 'GREEN', 'HACKED', 'HALO', 'HANZO', 'HAPPY', 'HEART', 'IGNORE CONDITION', 'INCORPORATE CONTRARY MOTION', 'INTERACT', 'INVINCIBLE', 'IS ASSEMBLING HEROES', 'IS BETWEEN ROUNDS', 'IS CONTROL MODE POINT LOCKED', 'IS CTF MODE IN SUDDEN DEATH', 'IS GAME IN PROGRESS', 'IS IN SETUP', 'IS MATCH COMPLETE', 'IS WAITING FOR PLAYERS', 'JUMP', 'JUNKRAT', 'KNOCKED DOWN', 'LAST CREATED ENTITY', 'LEFT', 'LIGHT SHAFT', 'LÚCIO', 'MCCREE', 'MEI', 'MERCY', 'MOIRA', 'MOON', 'NO', 'NONE', 'NULL', 'OFF', 'ONGOING - EACH PLAYER', 'ONGOING - GLOBAL', 'ORB', 'ORISA', 'PAYLOAD POSITION', 'PHARAH', 'PHASED OUT', 'PICK-UP SOUND', 'PLAYER DEALT DAMAGE', 'PLAYER DEALT FINAL BLOW', 'PLAYER DIED', 'PLAYER EARNED ELIMINATION', 'PLAYER TOOK DAMAGE', 'PLUS', 'POISON 2', 'POISON', 'POSITION AND RADIUS', 'PRIMARY FIRE', 'PURPLE', 'QUESTION MARK', 'RADIOACTIVE', 'REAPER', 'RECEIVERS AND DAMAGERS', 'RECEIVERS DAMAGERS AND DAMAGE PERCENT', 'RECYCLE', 'RED', 'REINHARDT', 'RESTART WHEN TRUE', 'RIGHT', 'RING EXPLOSION SOUND', 'RING EXPLOSION', 'RING THICK', 'RING THIN', 'RING', 'ROADHOG', 'ROOTED', 'SAD', 'SECONDARY FIRE', 'SKULL', 'SMOKE SOUND', 'SOLDIER: 76', 'SOMBRA', 'SPADE', 'SPARKLES SOUND', 'SPARKLES', 'SPHERE', 'SPIRAL', 'STOP', 'STRING', 'STUNNED', 'SURFACES AND ALL BARRIERS', 'SURFACES AND ENEMY BARRIERS', 'SURFACES', 'SYMMETRA', 'TEAM 1', 'TEAM 2', 'TO PLAYER', 'TO WORLD', 'TOP', 'TORBJÖRN', 'TRACER', 'TRASHCAN', 'TRUE', 'ULTIMATE', 'UNKILLABLE', 'UP', 'VICTIM', 'VISIBLE TO AND STRING', 'VISIBLE TO POSITION AND RADIUS', 'VISIBLE TO POSITION AND STRING', 'VISIBLE TO', 'WARNING', 'WHITE', 'WIDOWMAKER', 'WINSTON', 'WRECKING BALL', 'X', 'YELLOW', 'ZARYA', 'ZENYATTA']
